...
if(isset($_POST['update_proj'])){
    ...
    $noti_bi = "قام الأدمن بتحديث أحد مهامك .";
    // insert noti
    $in_noti = mysqli_query($con, "INSERT INTO notifics VALUES (default , 'adm', '$requester_id', '$employee', '$noti_bi' ,'na' ,'$date_added', 'no', 'no')");

    header("Location: track.php?edit_proj=$project_id&succ");
