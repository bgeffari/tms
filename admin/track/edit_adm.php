            ...
            <script>
                $(document).ready(function(){
                    ...
                    $('#delete<?php echo $dess; ?>').on('click', function(){
                        ...
                        bootbox.confirm("Are you sure you want to delete this Designer From this Section ?", function(result){

                            if(result == true){
                            
                                $.post("handlers/delete_missf_section.php?port_id=<?php echo $dess; ?>&sec_id=<?php echo $sec_id; ?>", {result:result});
                                location.reload();
