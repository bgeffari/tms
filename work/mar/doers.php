...
<div class="modal fade" id="add_doer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" dir="rtl">
  <div class="modal-dialog" role="document">
    ...
    if(isset($_POST['add_employ'])){
        ...
        $insert_query= mysqli_query($con, "INSERT INTO employees VALUES(default, N'$name', '$phone', '$password', '$section',N'$is_admin', 0)");
    ...
    <div class="list" dir="rtl">
        <div class="container">
            <div class="text-right">
                <h5>قائمة موظفي الخدمات في قسمك:</h5>
            </div>
            <?php
            $id = $_SESSION['sec_id'];
            $e_rows_query = mysqli_query($con, "SELECT * FROM employees WHERE sec_id = '$id' AND is_admin = 'no' ");
